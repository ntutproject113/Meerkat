...
url=["https://www.edu.tw/helpdreams/Grants.aspx?n=2BBF7170197CE7D3&sms=0A01A72AAB9E5CD4","https://www.edu.tw/helpdreams/Grants.aspx?n=11EFF33070D6DF4B&sms=931FF851D2FB2128"]
for html in url:
    driver.get(html)
    time.sleep(2)
...
with open("schoolarship.json", "w", encoding="utf-8") as f:
